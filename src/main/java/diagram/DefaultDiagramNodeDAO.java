...
public class DefaultDiagramNodeDAO implements org.apache.thrift.TBase<DefaultDiagramNodeDAO, DefaultDiagramNodeDAO._Fields>, java.io.Serializable, Cloneable, Comparable<DefaultDiagramNodeDAO> {
  ...
  private static final org.apache.thrift.protocol.TField PROPERTES_FIELD_DESC = new org.apache.thrift.protocol.TField("propertes", org.apache.thrift.protocol.TType.SET, (short)6);
  ...
  public Set<PropertyDAO> propertes; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.Y, new org.apache.thrift.meta_data.FieldMetaData("y", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    tmpMap.put(_Fields.PROPERTES, new org.apache.thrift.meta_data.FieldMetaData("propertes", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public DefaultDiagramNodeDAO(DefaultDiagramNodeDAO other) {
    ...
    this.x = other.x;
    this.y = other.y;
    if (other.isSetPropertes()) {
      Set<PropertyDAO> __this__propertes = new HashSet<PropertyDAO>(other.propertes.size());
      for (PropertyDAO other_element : other.propertes) {
        __this__propertes.add(new PropertyDAO(other_element));
      }
      this.propertes = __this__propertes;
    }
  }
  ...
  public int getPropertesSize() {
    return (this.propertes == null) ? 0 : this.propertes.size();
  }

  public java.util.Iterator<PropertyDAO> getPropertesIterator() {
    return (this.propertes == null) ? null : this.propertes.iterator();
  }

  public void addToPropertes(PropertyDAO elem) {
    if (this.propertes == null) {
      this.propertes = new HashSet<PropertyDAO>();
    }
    this.propertes.add(elem);
  }

  public Set<PropertyDAO> getPropertes() {
    return this.propertes;
  }

  public DefaultDiagramNodeDAO setPropertes(Set<PropertyDAO> propertes) {
    this.propertes = propertes;
    return this;
  }

  public void unsetPropertes() {
    this.propertes = null;
  }

  /** Returns true if field propertes is set (has been assigned a value) and false otherwise */
  public boolean isSetPropertes() {
    return this.propertes != null;
  }

  public void setPropertesIsSet(boolean value) {
    if (!value) {
      this.propertes = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PROPERTES:
      if (value == null) {
        ...
        setPropertes((Set<PropertyDAO>)value);
      }
      break;
  ...
  public boolean equals(DefaultDiagramNodeDAO that) {
    ...
    boolean this_present_propertes = true && this.isSetPropertes();
    boolean that_present_propertes = true && that.isSetPropertes();
    if (this_present_propertes || that_present_propertes) {
      if (!(this_present_propertes && that_present_propertes))
        return false;
      if (!this.propertes.equals(that.propertes))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_propertes = true && (isSetPropertes());
    list.add(present_propertes);
    if (present_propertes)
      list.add(propertes);
  ...
  public int compareTo(DefaultDiagramNodeDAO other) {
    ...
    lastComparison = Boolean.valueOf(isSetPropertes()).compareTo(other.isSetPropertes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPropertes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.propertes, other.propertes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class DefaultDiagramNodeDAOStandardScheme extends StandardScheme<DefaultDiagramNodeDAO> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.propertes = new HashSet<PropertyDAO>(2*_set0.size);
                PropertyDAO _elem1;
                for (int _i2 = 0; _i2 < _set0.size; ++_i2)
                {
                  _elem1 = new PropertyDAO();
                  _elem1.read(iprot);
                  struct.propertes.add(_elem1);
                }
                iprot.readSetEnd();
              }
              struct.setPropertesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DefaultDiagramNodeDAO struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.propertes != null) {
        oprot.writeFieldBegin(PROPERTES_FIELD_DESC);
        {
          oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, struct.propertes.size()));
          for (PropertyDAO _iter3 : struct.propertes)
          {
            _iter3.write(oprot);
          }
          oprot.writeSetEnd();
  ...
  private static class DefaultDiagramNodeDAOTupleScheme extends TupleScheme<DefaultDiagramNodeDAO> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, DefaultDiagramNodeDAO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPropertes()) {
        {
          oprot.writeI32(struct.propertes.size());
          for (PropertyDAO _iter4 : struct.propertes)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.propertes = new HashSet<PropertyDAO>(2*_set5.size);
          PropertyDAO _elem6;
          for (int _i7 = 0; _i7 < _set5.size; ++_i7)
          {
            _elem6 = new PropertyDAO();
            _elem6.read(iprot);
            struct.propertes.add(_elem6);
          }
        }
        struct.setPropertesIsSet(true);
      }
