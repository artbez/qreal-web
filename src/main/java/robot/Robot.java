...
public class Robot implements org.apache.thrift.TBase<Robot, Robot._Fields>, java.io.Serializable, Cloneable, Comparable<Robot> {
  ...
  public echo.User owner; // required
  ...
  public Robot(Robot other) {
    ...
    if (other.isSetOwner()) {
      this.owner = new echo.User(other.owner);
    }
  }
  ...
  public echo.User getOwner() {
    return this.owner;
  }

  public Robot setOwner(echo.User owner) {
    this.owner = owner;
    return this;
  }
