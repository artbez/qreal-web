 ...
 */
class DefaultDiagramNode2 implements DiagramNode2 {
    private jointObject: joint.shapes.devs.ImageWithPorts;
    private type: string;
    private properties: PropertiesMap2;
    private imagePath: string;

    constructor(type: string, x: number, y: number, properties: PropertiesMap2, imagePath: string, id?: string) {
        this.type = type;
