    ...
    DiagramController.prototype.finishDraw = function (e) {
        ...
        if (this.currentElement != undefined) {
            var elementBelow = this.graph.get('cells').find(function (cell) {
                ...
                if ((mXBegin <= leftElementPos) && (mXEnd >= leftElementPos) && (mYBegin <= topElementPos) && (mYEnd >= topElementPos) && (controller.rightClickFlag))
                    return true;
                return false;
            });
            if (elementBelow) {
                var link = new joint.dia.Link({
                    ...
                    target: { id: this.currentElement.getJointObject().id },
...
var KeyGiver = (function () {
    ...
    KeyGiver.prototype.makeKey = function () {
        var key = [];
        var index = 0;
    ...
    KeyGiver.prototype.isGesture = function () {
...
var TwoDRobotModel = (function (_super) {
    ...
    function TwoDRobotModel(realModel, name) {
        ...
        ImagePreloader.preloadImages(["images/2dmodel/trikKit/twoDColorEmpty.svg", "images/2dmodel/trikKit/twoDIrRangeSensor.svg", "images/2dmodel/trikKit/twoDUsRangeSensor.svg", "images/2dmodel/trikKit/twoDVideoModule.svg"]);
    }
